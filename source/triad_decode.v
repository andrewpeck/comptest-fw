...
// Ports
    input   wire         clock;              // 40MHz system clock
    input   wire         reset;              // State machine to idle
    input   wire [3:0]   persist;            // Output persistence-1, ie 5 gives 6-clk width
    input   wire         triad;              // 3-bit serial triad
    output  wire [3:0]   h_strip;            // 4-bit parallel 1/2-strips
